...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener() { const step_r59 = ctx.$implicit; return step_r59.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r65); const ctx_r64 = ɵngcc0.ɵɵnextContext(); return ctx_r64._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ...
    const isLast_r61 = ctx.last;
    const ctx_r57 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r57._getFocusIndex() === i_r60 ? 0 : 0 - 1)("id", ctx_r57._getStepLabelId(i_r60))("index", i_r60)("state", ctx_r57._getIndicatorType(i_r60, step_r59.state))("label", step_r59.stepLabel || step_r59.label)("selected", ctx_r57.selectedIndex === i_r60)("active", step_r59.completed || ctx_r57.selectedIndex === i_r60 || !ctx_r57.linear)("optional", step_r59.optional)("errorMessage", step_r59.errorMessage)("iconOverrides", ctx_r57._iconOverrides)("disableRipple", ctx_r57.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r60 + 1)("aria-setsize", ctx_r57.steps.length)("aria-controls", ctx_r57._getStepContentId(i_r60))("aria-selected", ctx_r57.selectedIndex == i_r60)("aria-label", step_r59.ariaLabel || null)("aria-labelledby", !step_r59.ariaLabel && step_r59.ariaLabelledby ? step_r59.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !isLast_r61);
} }
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r69 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r69); const ctx_r68 = ɵngcc0.ɵɵnextContext(); return ctx_r68._animationDone.next($event); });
    ɵngcc0.ɵɵelementContainer(1, 8);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const step_r66 = ctx.$implicit;
    const i_r67 = ctx.index;
    const ctx_r58 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r58._getAnimationDirection(i_r67))("id", ctx_r58._getStepContentId(i_r67));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r58.selectedIndex === i_r67 ? 0 : null)("aria-labelledby", ctx_r58._getStepLabelId(i_r67))("aria-expanded", ctx_r58.selectedIndex === i_r67);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r66.content);
} }
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatVerticalStepper_div_0_Template_mat_step_header_click_1_listener() { const step_r71 = ctx.$implicit; return step_r71.select(); })("keydown", function MatVerticalStepper_div_0_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r76); const ctx_r75 = ɵngcc0.ɵɵnextContext(); return ctx_r75._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵelementStart(3, "div", 4);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r76); const ctx_r77 = ɵngcc0.ɵɵnextContext(); return ctx_r77._animationDone.next($event); });
    ...
    const isLast_r73 = ctx.last;
    const ctx_r70 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r70._getFocusIndex() == i_r72 ? 0 : 0 - 1)("id", ctx_r70._getStepLabelId(i_r72))("index", i_r72)("state", ctx_r70._getIndicatorType(i_r72, step_r71.state))("label", step_r71.stepLabel || step_r71.label)("selected", ctx_r70.selectedIndex === i_r72)("active", step_r71.completed || ctx_r70.selectedIndex === i_r72 || !ctx_r70.linear)("optional", step_r71.optional)("errorMessage", step_r71.errorMessage)("iconOverrides", ctx_r70._iconOverrides)("disableRipple", ctx_r70.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r72 + 1)("aria-setsize", ctx_r70.steps.length)("aria-controls", ctx_r70._getStepContentId(i_r72))("aria-selected", ctx_r70.selectedIndex === i_r72)("aria-label", step_r71.ariaLabel || null)("aria-labelledby", !step_r71.ariaLabel && step_r71.ariaLabelledby ? step_r71.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-stepper-vertical-line", !isLast_r73);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r70._getAnimationDirection(i_r72))("id", ctx_r70._getStepContentId(i_r72));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r70.selectedIndex === i_r72 ? 0 : null)("aria-labelledby", ctx_r70._getStepLabelId(i_r72))("aria-expanded", ctx_r70.selectedIndex === i_r72);
    ɵngcc0.ɵɵadvance(2);
